...
namespace CAID
{
  public class HCL00024 : Page
  {
    ...
    protected HtmlSelect cmbEvaluacion;
    protected RequiredFieldValidator valcmbEvaluacion;
    ...
    protected void _Save(object sender, EventArgs e)
    {
      ...
      string str2 = this.cmbEvaluacion.Value.ToString();
      ...
      if (!((Site_Master) this.Master).Crear_ActoMédico(xREFGUID, xTERGUID, xESPGUID))
        return;
      if (DB.ExecuteNonQuery(string.Format("[HCL00024SI] '{0}','{1}','{2}','{3}','{4}','{5}','{6}'", (object) str1, (object) str2, (object) str3, (object) xREFGUID, (object) xTERGUID, (object) str4, (object) str5)))
      {
    ...
    private void Validar()
    {
      ...
      this.cmbEvaluacion.Value = string.Empty;
      this.cmbObjetivo.Value = string.Empty;
      this.rpHistorico.DataSource = (object) DB.ExecuteAdapter(string.Format("HCL00024H @REFGUID = '{0}', @ROWSGXID = '{1}'", this.Session["CurrentPAX_ROWGUID"], this.Session["CURRENTUSR_SGXID"]));
