  ...
  public class HCL00002 : Page
  {
    ...
    protected void _Save(object sender, EventArgs e)
    {
      ...
      if (!((Site_Master) this.Master).Crear_ActoMédico(xREFGUID, xTERGUID, xESPGUID))
        return;
      if (DB.ExecuteNonQuery(string.Format("[HCL00002SI] '{0}','{1}','{2}','{3}','{4}','{5}'", (object) str1, (object) str2, (object) xREFGUID, (object) xTERGUID, (object) str3, (object) str4)))
      {
    ...
    {
      DataTable dataTable1 = DB.ExecuteAdapter(string.Format("HCL00002V @TERGUID = '{0}', @ROWSGXID = '{1}', @REFGUID = '{2}'", this.Session["CurrentUSR_TERID"], this.Session["CURRENTUSR_SGXID"], this.Session["CurrentPAX_ROWGUID"]));
