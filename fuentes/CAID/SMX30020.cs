...
namespace CAID
{
  public class SMX30020 : Page
  {
    ...
    protected HtmlInputText txtCodigo1;
    protected RequiredFieldValidator valtxtCodigo1;
    protected HtmlInputText txtCodigo2;
    protected RequiredFieldValidator valtxtCodigo2;
    protected HtmlInputText txtCodigo3;
    protected RequiredFieldValidator valtxtCodigo3;
    ...
    private string CODIGO1
    {
      get
      {
        return this.txtCodigo1.Value.ToString().Trim().ToUpper();
      }
    }
    ...
    private string CODIGO2
    {
      get
      {
        return this.txtCodigo2.Value.ToString().Trim().ToUpper();
      }
    }
    ...
    private string CODIGO3
    {
      get
      {
        return this.txtCodigo3.Value.ToString().Trim().ToUpper();
      }
    }
    ...
    private void _Iniciar()
    {
      ...
      else
      {
        ...
        this.txtCodigo1.Value = dataRow["CODIGO1"].ToString();
        this.txtCodigo2.Value = dataRow["CODIGO2"].ToString();
        this.txtCodigo3.Value = dataRow["CODIGO3"].ToString();
    ...
    private void _IniciarControles()
    {
      ...
      this.txtCodigo1.Value = string.Empty;
      this.txtCodigo2.Value = string.Empty;
      this.txtCodigo3.Value = string.Empty;
    }
    ...
    protected void _Save(object sender, EventArgs e)
    {
      ...
      this.xQueryParameters.Add((object) "@CODIGO1");
      this.xQueryValues.Add((object) this.CODIGO1);
      this.xQueryParameters.Add((object) "@CODIGO2");
      this.xQueryValues.Add((object) this.CODIGO2);
      this.xQueryParameters.Add((object) "@CODIGO3");
      this.xQueryValues.Add((object) this.CODIGO3);
      this.xQueryParameters.Add((object) "@ROWGUID");
      this.xQueryValues.Add((object) this.ROWGUID);
      this.xQueryParameters.Add((object) "@ROWUSERID");
      this.xQueryValues.Add((object) this.ROWUSERID);
