...
namespace CAID
{
  public class SMX00200 : Page
  {
    ...
    protected HtmlInputText txtHabilitacion;
    protected RequiredFieldValidator RequiredFieldValidator2;
    protected HtmlInputText txtRNC;
    protected RequiredFieldValidator valtxtDescuento;
    ...
    private string NOMBRECORTO
    {
      get
      {
        return this.txtNombreCorto.Value.ToString().Trim().ToUpper();
      }
    }
    ...
    private string RNCID
    {
      get
      {
        return this.txtRNC.Value.ToString().Trim().ToUpper();
      }
    }

    private string HABILITACIONID
    {
      get
      {
        return this.txtHabilitacion.Value.ToString().Trim().ToUpper();
      }
    }
    ...
    private void _Iniciar()
    {
      ...
      else
      {
        ...
        this.txtNombreCorto.Value = dataRow["NOMBRECORTO"].ToString();
        this.txtHabilitacion.Value = dataRow["HABILITACIONID"].ToString();
        this.txtRNC.Value = dataRow["RNCID"].ToString();
    ...
    private void _IniciarControles()
    {
      ...
      this.txtNombreCorto.Value = string.Empty;
    ...
    protected void _Save(object sender, EventArgs e)
    {
      ...
      this.xQueryParameters.Add((object) "@NOMBRECORTO");
      this.xQueryValues.Add((object) this.NOMBRECORTO);
      this.xQueryParameters.Add((object) "@HABILITACIONID");
      this.xQueryValues.Add((object) this.HABILITACIONID);
      this.xQueryParameters.Add((object) "@RNCID");
      this.xQueryValues.Add((object) this.RNCID);
      this.xQueryParameters.Add((object) "@ROWGUID");
      this.xQueryValues.Add((object) this.ROWGUID);
      this.xQueryParameters.Add((object) "@ROWUSERID");
      this.xQueryValues.Add((object) this.ROWUSERID);
