...
namespace CAID
{
  public class FTX10103 : Page
  {
    ...
    protected RequiredFieldValidator valcmbCaja;
    ...
    protected HtmlInputText txtConcepto;
    protected HtmlInputText txtMonto;
    protected RequiredFieldValidator valtxtMonto;
    ...
    private string FECHA
    {
      get
      {
        return this.txtFecha.Value.ToString();
      }
    }
    ...
    private string CONCEPTO
    {
      get
      {
        return this.txtConcepto.Value.ToString().Trim().ToUpper();
      }
    }
    ...
    private double MONTO
    {
      get
      {
        return Convert.ToDouble(this.txtMonto.Value.ToString().Trim().ToUpper());
      }
    }
    ...
    private void _IniciarControles()
    {
      ...
      this.txtConcepto.Value = string.Empty;
      this.txtFecha.Value = string.Empty;
      this.txtMonto.Value = string.Empty;
    ...
    protected void _Save(object sender, EventArgs e)
    {
      ...
      this.xQueryParameters.Add((object) "@CONCEPTO");
      this.xQueryValues.Add((object) this.CONCEPTO);
      this.xQueryParameters.Add((object) "@MONTO");
      this.xQueryValues.Add((object) this.MONTO);
      this.xQueryParameters.Add((object) "@ROWGUID");
      this.xQueryValues.Add((object) this.ROWGUID);
      this.xQueryParameters.Add((object) "@ROWUSERID");
      this.xQueryValues.Add((object) this.ROWUSERID);
