...
namespace CAID
{
  public class SMX30001 : Page
  {
    ...
    protected HtmlInputText txtTasa;
    protected RequiredFieldValidator valtxtTasa;
    ...
    private Decimal TASA
    {
      get
      {
        return Convert.ToDecimal(this.txtTasa.Value.ToString().Trim());
      }
    }
    ...
    private void _Iniciar()
    {
      ...
      else
      {
        ...
        this.txtCodigo.Value = dataRow["MONEDAID"].ToString();
        this.txtTasa.Value = Convert.ToDecimal(dataRow["TASA"].ToString()).ToString();
    ...
    protected void _Save(object sender, EventArgs e)
    {
      ...
      this.xQueryParameters.Add((object) "@MONEDAID");
      this.xQueryValues.Add((object) this.MONEDAID);
      this.xQueryParameters.Add((object) "@TASA");
      this.xQueryValues.Add((object) this.TASA);
      this.xQueryParameters.Add((object) "@ROWGUID");
      this.xQueryValues.Add((object) this.ROWGUID);
      this.xQueryParameters.Add((object) "@ROWUSERID");
      this.xQueryValues.Add((object) this.ROWUSERID);
