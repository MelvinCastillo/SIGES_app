...
namespace CAID
{
  public class PAX00200 : Page
  {
    ...
    protected HtmlInputText txtDescuento;
    ...
    private Decimal DESCUENTO
    {
      get
      {
        return Convert.ToDecimal(this.txtDescuento.Value.ToString().Trim());
      }
    }
    ...
    private void _Iniciar()
    {
      ...
      else
      {
        ...
        this.txtDescuento.Value = Convert.ToDecimal(dataRow["DESCUENTO"].ToString()).ToString();
    ...
    protected void _Save(object sender, EventArgs e)
    {
      ...
      this.xQueryParameters.Add((object) "@DESCUENTO");
      this.xQueryValues.Add((object) this.DESCUENTO);
      this.xQueryParameters.Add((object) "@ROWGUID");
      this.xQueryValues.Add((object) this.ROWGUID);
      this.xQueryParameters.Add((object) "@ROWUSERID");
      this.xQueryValues.Add((object) this.ROWUSERID);
