  ...
  public class HCL00015 : Page
  {
    ...
    protected void _Save(object sender, EventArgs e)
    {
      ...
      if (!((Site_Master) this.Master).Crear_ActoMédico(xREFGUID, xTERGUID, xESPGUID))
        return;
      if (DB.ExecuteNonQuery(string.Format("[HCL00015SI] '{0}','{1}','{2}','{3}','{4}','{5}'", (object) str1, (object) str2, (object) xREFGUID, (object) xTERGUID, (object) str3, (object) str4)))
      {
    ...
    private void Validar()
    {
      ...
      this.rpHistorico.DataSource = (object) DB.ExecuteAdapter(string.Format("HCL00015H @REFGUID = '{0}', @ROWSGXID = '{1}'", this.Session["CurrentPAX_ROWGUID"], this.Session["CURRENTUSR_SGXID"]));
