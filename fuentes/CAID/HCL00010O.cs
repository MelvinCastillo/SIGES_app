...
namespace CAID
{
  public class HCL00010O : Page
  {
    ...
    protected HtmlSelect cmbPiezas;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      foreach (DataRow row in (InternalDataCollectionBase) DB.ExecuteAdapter(string.Format("SMX30026S3 @NOMBRE = '{0}', @ROWSGXID = '{1}'", (object) "%%", this.Session["CURRENTUSR_SGXID"])).Rows)
    ...
    private void Validar()
    {
      ...
      this.rpHistorico.DataSource = (object) DB.ExecuteAdapter(string.Format("HCL00010H @REFGUID = '{0}', @ROWSGXID = '{1}', @TIPO = '{2}'", this.Session["CurrentPAX_ROWGUID"], this.Session["CURRENTUSR_SGXID"], (object) "ODO"));
