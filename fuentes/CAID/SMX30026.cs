...
namespace CAID
{
  public class SMX30026 : Page
  {
    ...
    protected HtmlInputText txtCodigo;
    protected RequiredFieldValidator valtxtCodigo;
    protected HtmlSelect cmbOdont;
    protected RequiredFieldValidator valcmbOdont;
    ...
    private string CODIGO
    {
      get
      {
        return this.txtCodigo.Value.ToString().Trim().ToUpper();
      }
    }
    ...
    private string ODONTOLIGIA
    {
      get
      {
        return this.cmbOdont.Value.ToString().Trim().ToUpper();
      }
    }
    ...
    private void _Iniciar()
    {
      ...
      else
      {
        ...
        this.txtCodigo.Value = dataRow["CODIGO"].ToString();
        this.cmbOdont.Value = dataRow["ODONTOLIGIA"].ToString();
    ...
    private void _IniciarControles()
    {
      ...
      this.txtCodigo.Value = string.Empty;
    }
    ...
    protected void _Save(object sender, EventArgs e)
    {
      ...
      this.xQueryParameters.Add((object) "@CODIGO");
      this.xQueryValues.Add((object) this.CODIGO);
      this.xQueryParameters.Add((object) "@ROWGUID");
      this.xQueryValues.Add((object) this.ROWGUID);
      this.xQueryParameters.Add((object) "@ROWUSERID");
      this.xQueryValues.Add((object) this.ROWUSERID);
      this.xQueryParameters.Add((object) "@ROWSGXID");
      this.xQueryValues.Add((object) this.ROWSGXID);
      this.xQueryParameters.Add((object) "@ODONTOLIGIA");
      this.xQueryValues.Add((object) this.ODONTOLIGIA);
