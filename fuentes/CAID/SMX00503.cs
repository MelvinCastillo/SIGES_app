...
namespace CAID
{
  public class SMX00503 : Page
  {
    ...
    protected void cmbTerapista_SelectedIndexChanged(object sender, EventArgs e)
    {
      this.cmbHorario.Items.Clear();
      this.cmbHorario.Items.Add(new ListItem("-- SELECCIONE --", string.Empty));
      foreach (DataRow row in (InternalDataCollectionBase) DB.ExecuteAdapter(string.Format("[SMX10050P3] @TERID = '{0}',@FECHA = '{1}'", (object) this.TERID, (object) this.FECHAINI)).Rows)
    ...
    protected void _Save(object sender, EventArgs e)
    {
      ...
      for (int index = 0; index <= num - 1; ++index)
      {
        ...
        this.xQueryValues.Add((object) "CG");
    ...
    {
      this.Response.Redirect("SMX00503.aspx");
    }
