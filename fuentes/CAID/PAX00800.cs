...
namespace CAID
{
  public class PAX00800 : Page
  {
    ...
    protected DropDownList cmbEstatus;
    ...
    private string ESTATUS
    {
      get
      {
        return this.cmbEstatus.SelectedValue.ToString().Trim().ToUpper();
      }
    }
    ...
    private void _Iniciar()
    {
      ...
      this.cmbEstatus.Items.Add(new ListItem("-- SELECCIONE --", string.Empty));
      foreach (DataRow row in (InternalDataCollectionBase) DB.ExecuteAdapter("SMX30051S1", this.xQueryParameters, this.xQueryValues, CommandType.StoredProcedure).Rows)
        this.cmbEstatus.Items.Add(new ListItem(row["NOMBRE"].ToString(), row["ROWGUID"].ToString()));
      ...
      else
      {
        ...
        if (dataRow == null)
          return;
        this.cmbEstatus.SelectedValue = dataRow["ESTATUS"].ToString();
    ...
    private void _IniciarControles()
    {
      ...
      this.cmbEstatus.SelectedValue = string.Empty;
    }
