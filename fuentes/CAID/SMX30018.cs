...
namespace CAID
{
  public class SMX30018 : Page
  {
    ...
    protected HtmlSelect txtTipo;
    protected RequiredFieldValidator txtTipo1;
    ...
    private string CONDICION
    {
      get
      {
        return this.txtTipo.Value.ToString().Trim().ToUpper();
      }
    }
    ...
    private void _Iniciar()
    {
      ...
      else
      {
        ...
        this.txtTipo.Value = dataRow["CONDICION"].ToString();
    ...
    private void _IniciarControles()
    {
      ...
      this.txtTipo.Value = string.Empty;
    }
    ...
    protected void _Save(object sender, EventArgs e)
    {
      ...
      this.xQueryValues.Add((object) this.CONDICION);
