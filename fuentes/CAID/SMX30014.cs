...
namespace CAID
{
  public class SMX30014 : Page
  {
    ...
    protected HtmlInputText txtShortName;
    protected RequiredFieldValidator valtxtShortName;
    ...
    private string NOMBRECORTO
    {
      get
      {
        return this.txtShortName.Value.ToString().Trim().ToUpper();
      }
    }
    ...
    private void _Iniciar()
    {
      ...
      else
      {
        ...
        this.txtShortName.Value = dataRow["NOMBRECORTO"].ToString();
