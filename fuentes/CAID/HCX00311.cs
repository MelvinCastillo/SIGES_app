...
namespace CAID
{
  public class HCX00311 : Page
  {
    ...
    private void _Iniciar()
    {
      ...
      foreach (DataRow row in (InternalDataCollectionBase) DB.ExecuteAdapter("HCX00310S1", this.xQueryParameters, this.xQueryValues, CommandType.StoredProcedure).Rows)
      ...
      else
      {
        ...
        this.cmbObjetivo.Value = dataRow["OBJETIVOID"].ToString();
    ...
    protected void _Save(object sender, EventArgs e)
    {
      ...
      this.xQueryValues.Add((object) this.OBJETIVOID);
      this.xQueryParameters.Add((object) "@ROWGUID");
      this.xQueryValues.Add((object) this.ROWGUID);
      this.xQueryParameters.Add((object) "@ROWUSERID");
      this.xQueryValues.Add((object) this.ROWUSERID);
