...
namespace CAID
{
  public class SMX00005 : Page
  {
    ...
    private string PAISID
    {
      get
      {
        return this.cmbPais.Value.ToString().Trim().ToUpper();
      }
    }
    ...
    private void _Iniciar()
    {
      ...
      foreach (DataRow row in (InternalDataCollectionBase) DB.ExecuteAdapter("SMX00001S3", this.xQueryParameters, this.xQueryValues, CommandType.StoredProcedure).Rows)
      ...
      else
      {
        ...
        this.cmbPais.Value = dataRow["PAISID"].ToString();
