...
namespace CAID
{
  public class HCL00039R1 : Page
  {
    ...
    {
      this.Session.Add("REPORT_URL", (object) "~/reports/HCL00039R1.rpt");
      this.Session.Add("REPORT_DATASOURCE", (object) string.Format("[HCL00039R1] @ROWSGXID = '{0}',@REFGUID = '{1}',@ROWUSERID = '{2}',@ESPGUID = '{3}'", (object) this.ROWSGXID, (object) this.REFGUID, (object) this.ROWUSERID, (object) this.ESPGUID));
