...
namespace CAID
{
  public class SMX30024 : Page
  {
    ...
    protected HtmlSelect cmbOrigen;
    protected RequiredFieldValidator cmbOrigen1;
    ...
    private string ORIGEN
    {
      get
      {
        return this.cmbOrigen.Value.ToString().Trim().ToUpper();
      }
    }
    ...
    private void _Iniciar()
    {
      ...
      else
      {
        ...
        this.cmbOrigen.Value = dataRow["ORIGEN"].ToString();
    ...
    private void _IniciarControles()
    {
      ...
      this.cmbOrigen.Value = string.Empty;
    }
    ...
    protected void _Save(object sender, EventArgs e)
    {
      ...
      this.xQueryParameters.Add((object) "@ORIGEN");
      this.xQueryValues.Add((object) this.ORIGEN);
      this.xQueryParameters.Add((object) "@ROWGUID");
      this.xQueryValues.Add((object) this.ROWGUID);
      this.xQueryParameters.Add((object) "@ROWUSERID");
      this.xQueryValues.Add((object) this.ROWUSERID);
