...
namespace CAID
{
  public class SMX00004 : Page
  {
    ...
    protected HtmlSelect cmbMunicipio;
    ...
    private string MUNICIPIOID
    {
      get
      {
        return this.cmbMunicipio.Value.ToString().Trim().ToUpper();
      }
    }
    ...
    private void _Iniciar()
    {
      ...
      this.cmbMunicipio.Items.Add(new ListItem("-- SELECCIONE --", string.Empty));
      foreach (DataRow row in (InternalDataCollectionBase) DB.ExecuteAdapter("SMX00003S1", this.xQueryParameters, this.xQueryValues, CommandType.StoredProcedure).Rows)
        this.cmbMunicipio.Items.Add(new ListItem(row["NOMBRE"].ToString(), row["ROWGUID"].ToString()));
      ...
      else
      {
        ...
        this.cmbMunicipio.Value = dataRow["MUNICIPIOID"].ToString();
