...
namespace CAID
{
  public class SMX00101 : Page
  {
    ...
    protected HtmlSelect cmbTContacto;
    protected RequiredFieldValidator valcmbTContacto;
    ...
    private string TIPOCONTACTOID
    {
      get
      {
        return this.cmbTContacto.Value.ToString().Trim();
      }
    }
    ...
    private void _Iniciar()
    {
      ...
      this.cmbTContacto.Items.Clear();
      this.cmbTContacto.Items.Add(new ListItem("-- SELECCIONE --", string.Empty));
      foreach (DataRow row in (InternalDataCollectionBase) DB.ExecuteAdapter("SMX30004S1", this.xQueryParameters, this.xQueryValues, CommandType.StoredProcedure).Rows)
        this.cmbTContacto.Items.Add(new ListItem(row["NOMBRE"].ToString(), row["ROWGUID"].ToString()));
      ...
      else
      {
        ...
        if (dataRow == null)
          return;
        this.txtNombre.Value = dataRow["CONTACTO"].ToString();
        this.cmbTContacto.Value = dataRow["TIPOCONTACTOID"].ToString();
    ...
    private void _IniciarControles()
    {
      ...
      this.cmbTContacto.Value = string.Empty;
    }
    ...
    protected void _Show(object sender, EventArgs e)
    {
      this.xQueryParameters.Clear();
      this.xQueryValues.Clear();
      this.xQueryParameters.Add((object) "@CONTACTO");
      this.xQueryValues.Add((object) "%");
      this.xQueryParameters.Add((object) "@ROWSGXID");
      this.xQueryValues.Add((object) this.ROWSGXID);
    ...
    protected void _Save(object sender, EventArgs e)
    {
      ...
      this.xQueryParameters.Add((object) "@CONTACTO");
      this.xQueryValues.Add((object) this.CONTACTO);
      this.xQueryParameters.Add((object) "@TIPOCONTACTOID");
      this.xQueryValues.Add((object) this.TIPOCONTACTOID);
      this.xQueryParameters.Add((object) "@ROWGUID");
      this.xQueryValues.Add((object) this.ROWGUID);
      this.xQueryParameters.Add((object) "@ROWUSERID");
      this.xQueryValues.Add((object) this.ROWUSERID);
