...
namespace CAID
{
  public class HCX00001 : Page
  {
    ...
    protected HtmlButton btnPrint2;
    protected HtmlButton Button3;
    protected Repeater rpCarnet;
    ...
    private string ROOTDIRECTORY
    {
      get
      {
        return this.Server.MapPath(".\\records\\") + this.REFGUID + "\\carnets\\";
      }
    }
    ...
    protected void _Select(object sender, EventArgs e)
    {
      ...
      try
      {
        ...
        if (this.xCommand == "PrintID")
        {
          ...
          {
            this.rpCarnet.DataSource = (object) dataTable;
            this.rpCarnet.DataBind();
            this.pnlConsulta.Visible = false;
            this.pnlData.Visible = false;
    ...
    protected void _Save(object sender, EventArgs e)
    {
      ...
      else
      {
        ...
        if (this.File1.PostedFile != null && this.File1.PostedFile.ContentLength > 0)
        {
          ...
          string filename = string.Format("{0}{1}", (object) (this.ROOTDIRECTORY + this.REFGUID), (object) extension);
          try
          {
            flag = true;
          ...
          finally
          {
            if (flag)
            {
              this.xQueryParameters.Clear();
              this.xQueryValues.Clear();
              this.ARCHIVO = string.Format("{0}{1}", (object) this.REFGUID, (object) extension);
