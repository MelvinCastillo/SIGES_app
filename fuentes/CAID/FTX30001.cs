...
namespace CAID
{
  public class FTX30001 : Page
  {
    ...
    protected HtmlInputText txtPrefijo;
    protected RequiredFieldValidator valtxtPrefijo;
    ...
    private string PREFIJO
    {
      get
      {
        return this.txtPrefijo.Value.ToString().Trim().ToUpper();
      }
    }
    ...
    private void _Iniciar()
    {
      ...
      else
      {
        ...
        this.txtPrefijo.Value = dataRow["PREFIJO"].ToString();
    ...
    protected void _Save(object sender, EventArgs e)
    {
      ...
      this.xQueryParameters.Add((object) "@PREFIJO");
      this.xQueryValues.Add((object) this.PREFIJO);
