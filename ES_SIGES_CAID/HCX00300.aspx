<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="HCX00300.aspx.cs" Inherits="CAID.HCX00300" %>
        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="box  box-bordered">
                    <div class="box-title">
                        <h3>
                            <i class="icon-table"></i>PLAN DE TRATAMIENTO
                        </h3>
                    </div>
                    <div class="box-content nopadding">
                        <div class='form-horizontal form-bordered'>
                            ...
                            <div class="control-group">
                                <table class="table table-hover table-nomargin table-bordered dataTable dataTable-scroll-x dataTable-grouping" data-grouping="expandable">
                                    <thead>
                                        <tr>
                                            <th>Pacientes
                                            </th>
                                                        ...
                                                        <asp:Repeater ID="rpDetalles" runat="server">
                                                            <ItemTemplate>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:LinkButton ID="btnUpdateDet" CssClass="btn btn-blue" runat="server" Text="Actualizar"
                                                                            CommandArgument='<%# Eval("ROWGUID")%>' CommandName="UpdateDet" OnClick="_Select2"></asp:LinkButton>
