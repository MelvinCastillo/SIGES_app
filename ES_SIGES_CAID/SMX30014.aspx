<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="SMX30014.aspx.cs" Inherits="CAID.SMX30014" %>
        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="box  box-bordered">
                    <div class="box-title">
                        <h3>
                            <i class="icon-table"></i>ORIGEN DE ATENCION
                        </h3>
                    </div>
                    <div class="box-content nopadding">
        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="box box-bordered">
                    <div class="box-title">
                        <h3>
                            <i class="icon-edit"></i>Registro de Origenes de Atencion</h3>
                    </div>
                    <div class="row-fluid">
                        <div class="box-content nopadding">
                            <div class='form-horizontal form-bordered'>
                                ...
                                <%-- Nombre Corto --%>
                                <div class="control-group">
                                    <label for="txtShortName" class="control-label" style="color: Red">
                                        Nombre corto</label>
                                    <div class="controls">
                                        <input runat="server" name="txtShortName" id="txtShortName" type="text" class="input-xlarge"
                                            data-rule-required="true">
                                        <br />
                                        <asp:RequiredFieldValidator ControlToValidate="txtShortName" Display="Dynamic" ErrorMessage="Requerido!"
                                            ID="valtxtShortName" runat="server" SetFocusOnError="True" ValidationGroup="pnlData" />
                                    </div>
                                </div>
                            </div>
                        </div>
