<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="PAX00100_G.aspx.cs" Inherits="CAID.PAX00100_G" %>
        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="box  box-bordered">
                    <div class="box-title">
                        <h3>
                            <i class="icon-table"></i>GRUPOS DE PREGUNTAS
                        </h3>
                    </div>
                    <div class="box-content nopadding">
        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="box box-bordered">
                    <div class="box-title">
                        <h3>
                            <i class="icon-edit"></i>Registro de Grupos de Preguntas</h3>
                    </div>
                    <div class="row-fluid">
                        <div class="box-content nopadding">
                               ...
                               <%-- Codigo --%>
                                <div class="control-group">
                                    <label for="txtCodigo" class="control-label" style="color: Red">
                                        Código</label>
                                    <div class="controls">
                                        <input runat="server" name="txtCodigo" id="txtCodigo" type="text" class="input-xlarge"
                                            data-rule-required="true">
                                        <br />
                                        <asp:RequiredFieldValidator ControlToValidate="txtCodigo" Display="Dynamic" ErrorMessage="Requerido!"
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input runat="server" name="txtOrden" id="txtOrden" type="text" class='input-small'
                                            data-rule-required="true">
                                        <br />
                                        <asp:RequiredFieldValidator ID="valtxtOrden" ControlToValidate="txtOrden" Display="Dynamic" ErrorMessage="Requerido!"
                                            runat="server" SetFocusOnError="True" ValidationGroup="pnlData" />
                                    </div>
                                </div>
                            </div>
                        </div>
