<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="SMX00003.aspx.cs" Inherits="CAID.SMX00003" %>
        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="box  box-bordered">
                    <div class="box-title">
                        <h3>
                            <i class="icon-table"></i>MUNICIPIOS
                        </h3>
                    </div>
                    <div class="box-content nopadding">
        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="box box-bordered">
                    <div class="box-title">
                        <h3>
                            <i class="icon-edit"></i>Registro de Municipio</h3>
                    </div>
                    <div class="row-fluid">
                        <div class="box-content nopadding">
                            <div class='form-horizontal form-bordered'>
                                ...
                                <!-- Provincia -->
                                <div class="control-group">
                                    <label for="cmbProvincia" class="control-label" style="color: Red">
                                        Provincia</label>
                                    <div class="controls">
                                        <select runat="server" id="cmbProvincia" name="cmbProvincia" class='select2-me input-block-level'
                                            data-rule-required="true">
                                        </select>
                                    </div>
                                </div>
