<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="SMX00002.aspx.cs" Inherits="CAID.SMX00002" %>
        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="box box-bordered">
                    <div class="box-title">
                        <h3>
                            <i class="icon-edit"></i>Registro de Ciudades</h3>
                    </div>
                    <div class="row-fluid">
                        <div class="box-content nopadding">
                            <div class='form-horizontal form-bordered'>
                                ...
                                <div class="control-group">
                                    <label for="cmbPais" class="control-label" style="color: Red">
                                        País</label>
                                    <div class="controls">
                                        <select runat="server" id="cmbPais" name="cmbPais" class='select2-me input-block-level'
                                            data-rule-required="true">
                                        </select>
                                        <br />
