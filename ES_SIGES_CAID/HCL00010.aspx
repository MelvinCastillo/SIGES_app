<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="HCL00010.aspx.cs" Inherits="CAID.HCL00010" %>
                            ...
                            <asp:Repeater ID="rpHistorico" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td> 
                                            <button type="button" data-toggle="modal"   class="btn btn-primary" id="btnCambiarEstatus"   onclick="window.open('http://caidsiges01:8082/forms/actualizadb.aspx?PROCESO=UpdateTratamiento&Paciente=<%# Eval("REFGUID")%>&terapistaid=<%# Eval("TERAPEUTA")%>&sucursal=<%# Eval("ROWSGXID")%>&ROWGUID=<%# Eval("ROWGUID")%>' ,'_blank', 'toolbar=no,scrollbars=no,resizable=yes,top=100,left=300,width=500,height=200'); window.location.reload(false);">Actualizar</button>
                                            <%# Eval("ESTATUSICONO")%>   
                                         </td>   
                                    </tr>
                                </ItemTemplate>
