<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="FTX30001.aspx.cs" Inherits="CAID.FTX30001" %>
        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="box  box-bordered">
                    <div class="box-title">
                        <h3>
                            <i class="icon-table"></i>TIPOS DE COMPROBANTES FISCALES
                        </h3>
                    </div>
                    <div class="box-content nopadding">
        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="box box-bordered">
                    <div class="box-title">
                        <h3>
                            <i class="icon-edit"></i>Registrar Tipos de Comprobantes Fiscales</h3>
                    </div>
                    <div class="row-fluid">
                        <div class="box-content nopadding">
                            <div class='form-horizontal form-bordered'>
                                ...
                                <%-- Prefijo --%>
                                <div class="control-group">
                                    <label for="txtPrefijo" class="control-label" style="color: Red">
                                        Prefijo</label>
                                    <div class="controls">
                                        <input runat="server" name="txtPrefijo" id="txtPrefijo" type="text" class="input-xlarge"
                                            data-rule-required="true">
                                        <br />
                                        <asp:RequiredFieldValidator ControlToValidate="txtPrefijo" Display="Dynamic" ErrorMessage="Requerido!"
                                            ID="valtxtPrefijo" runat="server" SetFocusOnError="True" ValidationGroup="pnlData" />
                                    </div>
                                </div>
                            </div>
                        </div>
