<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="HC20007.aspx.cs" Inherits="CAID.HC20007" %>
    ...
    <div class="row-fluid">
        <div class="box">
            <div class="box box-bordered">
                <div class="box-title">
                    <h3>
                        <i class="icon-edit"></i>Tratamientos</h3>
                    <div class="actions">
                        <a href="#modal-mnt-labs" data-toggle="modal" class="btn btn-mini"><i class="icon-plus-sign"
                            rel="tooltip" title="Añadir"></i>&nbsp Añadir Tratamiento</a>
                    </div>
                </div>
            ...
            <div class='form-horizontal form-bordered'>
                <div class="box-content nopadding">
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select runat="server" id="txtPRINCIPIOACTIVO" class='select2-me input-block-level'>
                                <option value="">-- SELECCIONE --</option>
                            </select>
                            &nbsp
                            <asp:RequiredFieldValidator ControlToValidate="txtPRINCIPIOACTIVO" Display="Dynamic"
                                ErrorMessage="Requerido!" ForeColor="Red" ID="txtPRINCIPIOACTIVO1" runat="server"
