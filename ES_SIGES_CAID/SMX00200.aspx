<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="SMX00200.aspx.cs" Inherits="CAID.SMX00200" %>
        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="box box-bordered">
                    <div class="box-title">
                        <h3>
                            <i class="icon-edit"></i>Registro de ARS</h3>
                    </div>
                    <div class="row-fluid">
                        <div class="box-content nopadding">
                            <div class='form-horizontal form-bordered'>
                                ...
                                <%-- Descipción Corta --%>
                                <div class="control-group">
                                    <label for="txtNombreCorto" class="control-label" style="color: Red">
                                        Descripción Corta</label>
                                    <div class="controls">
                                        <input runat="server" name="txtNombreCorto" id="txtNombreCorto" type="text" class="input-xlarge"
                                            data-rule-required="true" Style="text-transform: uppercase">
                                        <asp:RequiredFieldValidator ControlToValidate="txtNombreCorto" Display="Dynamic" ErrorMessage="Requerido!"
                                ...
                                <div class="control-group">
                                    <label for="txtNombre" class="control-label" style="color: Red">
                                        Habilitación</label>
                                    <div class="controls">
                                        <input runat="server" name="txtHabilitacion" id="txtHabilitacion" type="text" class="input-xlarge"
                                            data-rule-required="true" Style="text-transform: uppercase">
                                        <asp:RequiredFieldValidator ControlToValidate="txtHabilitacion" Display="Dynamic" ErrorMessage="Requerido!"
...
<%--
                                ...
                                <div class="control-group">
                                    <label for="cmbPais" class="control-label" style="color: Red">
                                        Habilitación</label>
                                    <div class="controls">
                                        <select runat="server" id="cmbHabilitacion" name="cmbPais" class='select2-me input-block-level'
                                ...
                                <div class="control-group">
                                    <label for="txtRNC" class="control-label" style="color: Red">
                                        RNC</label>
                                    <div class="controls">
                                        <input runat="server" name="txtRNC" id="txtRNC" type="text" placeholder="RNC o Cédula"
                                            class='input-large' Style="text-transform: uppercase">
                                        <span class="add-on"></span>
                                        <br />
                                        <asp:RequiredFieldValidator ControlToValidate="txtRNC" Display="Dynamic" ErrorMessage="Requerido!"
