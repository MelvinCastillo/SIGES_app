<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="SMX00004.aspx.cs" Inherits="CAID.SMX00004" %>
        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="box box-bordered">
                    <div class="box-title">
                        <h3>
                            <i class="icon-edit"></i>Registro de Sectores</h3>
                    </div>
                    <div class="row-fluid">
                        <div class="box-content nopadding">
                            <div class='form-horizontal form-bordered'>
                                ...
                                <!-- Provincia -->
                                <div class="control-group">
                                    <label for="cmbMunicipio" class="control-label" style="color: Red">
                                        Municipio</label>
                                    <div class="controls">
                                        <select runat="server" id="cmbMunicipio" name="cmbMunicipio" class='select2-me input-block-level'
                                            data-rule-required="true">
                                        </select>
                                    </div>
                                </div>
