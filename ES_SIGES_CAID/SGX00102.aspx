<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="SGX00102.aspx.cs" Inherits="CAID.SGX00102" %>
        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="box  box-bordered">
                    <div class="box-title">
                        <h3>
                            <i class="icon-table"></i>MIS FAVORITOS
                        </h3>
                    </div>
                    <div class="box-content nopadding">
                        ...
                        <div class="box-content nopadding">
                            <div class='form-horizontal form-bordered'>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select runat="server" id="cmbNodoId" name="cmbNodoId" class='select2-me input-block-level'
                                            data-rule-required="true">
                                        </select>
                                        <br />
                                ...
                                <div class="control-group">
                                    <label for="cmbFormularios" class="control-label" style="color: Red">
                                        URL</label>
                                    <div class="controls">
                                        <select runat="server" id="cmbFormularios" name="cmbFormularios" class='select2-me input-block-level'
                                            data-rule-required="true">
                                        </select>
                                    </div>
                                </div>
