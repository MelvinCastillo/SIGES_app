<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="PAX00100_MC.aspx.cs" Inherits="CAID.PAX00100_MC" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <asp:Panel runat="server" ID="pnlConsulta">
        <div class="box  box-bordered">
            <div class="box-title">
                <h3>
                    <i class="icon-calendar"></i>Actualización de Categorías para Pacientes</h3>
            </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <button id="btnShow" runat="server" onserverclick="_Show" class="btn content-refresh btn-primary">
                                <i class="icon-refresh"></i>&nbsp Buscar</button>
                        </div>
                    </div>
                    <div class="control-group">
                        <div class="box-content nopadding">
                                        ...
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <%# Eval("MODALNUC")%>
                                                    &nbsp
                                                    <asp:LinkButton ID="btnActualizar" CssClass="btn btn-blue" runat="server" Text="Actualizar"
                                                        CommandArgument='<%# Eval("ROWGUID")%>' CommandName="Edit" OnClick="_Select"
                                                        OnClientClick="return confirm('¿Está seguro que desea actualizar la categoria del paciente?');"></asp:LinkButton>
                                                </td>
                                            </tr>
                                        </ItemTemplate>
                                    </asp:Repeater>
        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="box box-bordered">
                    <div class="box-title">
                        <h3>
                            <i class="icon-edit"></i>Actualización de Categoías de Pacientes</h3>
                    </div>
                    <div class="row-fluid">
                        <div class="box-content nopadding">
                            <div class='form-horizontal form-bordered'>
