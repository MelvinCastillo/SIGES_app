    ...
    $.extend(PageGuide, {
        ...
        prototype: {
            ...
            init: function() {
                ...
                message.append('<a class="pageguide-close" title="Close Guide">close</a>').append('<span class="pageguide-index"></span>').append('<div class="pageguide-content"></div>').append('<a class="pageguide-back" title="Anterior">Previous</a>').append('<a class="pageguide-fwd" title="Siguiente">Next</a>');
