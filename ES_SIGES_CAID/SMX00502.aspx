<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="SMX00502.aspx.cs" Inherits="CAID.SMX00502" %>
        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="box  box-bordered">
                    <div class="box-title">
                        <h3>
                            <i class="icon-table"></i>Programación de Citas para Ruta Básica
                        </h3>
                        <div class="actions">
    ...
    <asp:Panel runat="server" ID="pnlData">
        <div class="row-fluid">
            ...
            <div class="box box-bordered">
                <div class="box-title">
                    <h3>
                        <i class="icon-edit"></i>Registro de Citas para Ruta Básica</h3>
                    <div class="actions">
