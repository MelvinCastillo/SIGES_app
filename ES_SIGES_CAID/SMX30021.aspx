<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="SMX30021.aspx.cs" Inherits="CAID.SMX30021" %>
        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="box  box-bordered">
                    <div class="box-title">
                        <h3>
                            <i class="icon-table"></i>ESTUDIOS DE LABORATORIOS
                        </h3>
                    </div>
                    <div class="box-content nopadding">
        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="box box-bordered">
                    <div class="box-title">
                        <h3>
                            <i class="icon-edit"></i>Registro de Laboratorios</h3>
                    </div>
                    <div class="row-fluid">
                        <div class="box-content nopadding">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <asp:RequiredFieldValidator ControlToValidate="txtNombreCorto" Display="Dynamic" ErrorMessage="Requerido!"
                                            ID="valtxtNombreCorto" runat="server" SetFocusOnError="True" ValidationGroup="pnlData" />
                                    </div>
                                </div>
