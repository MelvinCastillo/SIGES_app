<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="PAX20101R1.aspx.cs" Inherits="CAID.PAX20101R1" %>
            ...
            <div class="row-fluid">
                <div class="span12">
                    <div class="box box-bordered">
                        <div class="box-title">
                            <h3>
                                <i class="icon-edit"></i>Reporte de Visitas e Interacciones</h3>
                            <div class="actions">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <select runat="server" id="cmbTipo" name="cmbTipo" class='select2-me input-block-level'
                                                ...
                                                <option value="2">INTERACCIÓN</option>
                                            </select>
                                        </div>
                                    </div>
                                    <!-- Período -->
                                                    ...
                                                    <asp:Repeater ID="rpData" runat="server">
                                                        <ItemTemplate>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <%# Eval("DOCUMENTO")%> &nbsp: <%# Eval("CEDULAID")%>
                                                                </td>
                                                                <td>
                                                                    <%# Eval("PACIENTEDET")%>
                                                                </td>
