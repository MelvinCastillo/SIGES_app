<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="PAX20101R3.aspx.cs" Inherits="CAID.PAX20101R3" %>
        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="box  box-bordered">
                    <div class="box-title">
                        <h3>
                            <i class="icon-table"></i>SALIDAS PENDIENTES
                        </h3>
                    </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <input runat="server" name="txtFecha2" id="txtFecha2" class="input-medium datepick"
                                        data-date-autoclose="True" data-rule-required="true" placeholder="mm/dd/aaaa">
                                    &nbsp
                                    <button type="button" id="Button1" runat="server" onserverclick="_Show" class="btn btn-primary">
