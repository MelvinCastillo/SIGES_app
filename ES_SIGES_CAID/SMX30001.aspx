<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="SMX30001.aspx.cs" Inherits="CAID.SMX30001" %>
        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="box  box-bordered">
                    <div class="box-title">
                        <h3>
                            <i class="icon-table"></i>TIPOS DE MONEDAS
                        </h3>
                    </div>
                    <div class="box-content nopadding">
        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="box box-bordered">
                    <div class="box-title">
                        <h3>
                            <i class="icon-edit"></i>Registro de Monedas</h3>
                    </div>
                    <div class="row-fluid">
                        <div class="box-content nopadding">
                            <div class='form-horizontal form-bordered'>
                                ...
                                <div class="control-group">
                                    <label for="txtCodigo" class="control-label" style="color: Red">
                                        Código Internacional</label>
                                    <div class="controls">
                                        <input runat="server" name="txtCodigo" id="txtCodigo" type="text" class='input-small'
                                            data-rule-required="true">
                                        <br />
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="txtCodigo"
                                            Display="Dynamic" ErrorMessage="Requerido!" D="valtxtCodigo" runat="server" SetFocusOnError="True"
                                            ValidationGroup="pnlData" />
                                    </div>
                                </div>
                                <%-- Tasa --%>
                                <div class="control-group">
                                    <label for="txtTasa" class="control-label" style="color: Red">
                                        Tasa Actual</label>
                                    <div class="controls">
                                        <input runat="server" name="txtTasa" id="txtTasa" type="text" class='input-small'
                                            data-rule-required="true">
                                        <br />
                                        <asp:RequiredFieldValidator ID="valtxtTasa" ControlToValidate="txtTasa" Display="Dynamic"
