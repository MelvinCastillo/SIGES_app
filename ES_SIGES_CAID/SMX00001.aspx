<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="SMX00001.aspx.cs" Inherits="CAID.SMX00001" %>
        ...
        <div class="row-fluid">
            <div class="span12">
                <div class="box box-bordered">
                    <div class="box-title">
                        <h3>
                            <i class="icon-edit"></i>Registro de Países</h3>
                    </div>
                    <div class="row-fluid">
                        <div class="box-content nopadding">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input runat="server" name="txtCodigo" id="txtCodigo" type="text" class='input-small'
                                            data-rule-required="true">
                                        <br />
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="txtCodigo" Display="Dynamic" ErrorMessage="Requerido!"
                                            D="valtxtCodigo" runat="server" SetFocusOnError="True" ValidationGroup="pnlData" />
                                    </div>
                                </div>
                            </div>
                        </div>
